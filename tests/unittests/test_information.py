...
from jnkepler.information import information_from_model_iid
# autopep8: on
...
def test_information_from_model_iid():
    ...
    info_c = information_from_model_iid(model=model_iid_normal, mu_name="tcmodel", pdic=pdic, keys=sample_keys, sigma_sd=jttv.errorobs_flatten, observed=jttv.tcobs_flatten, param_space="constrained",
                                        model_args=(sample_keys, param_bounds))['fisher']
    info_c_ref = np.loadtxt(path/"info.txt")
    assert np.allclose(info_c, info_c_ref)

    info_u = information_from_model_iid(model=model_iid_normal, mu_name="tcmodel", pdic=pdic, keys=sample_keys, sigma_sd=jttv.errorobs_flatten, observed=jttv.tcobs_flatten, param_space="unconstrained",
                                        model_args=(sample_keys, param_bounds))['fisher']
    ...
    info_c_lnpmass = information_from_model_iid(model=model_iid_normal, mu_name="tcmodel", pdic=pdic, keys=sample_keys_lnpmass, sigma_sd=jttv.errorobs_flatten, observed=jttv.tcobs_flatten, param_space="constrained",
    ...
    info_u_lnpmass = information_from_model_iid(model=model_iid_normal, mu_name="tcmodel", pdic=pdic, keys=sample_keys_lnpmass, sigma_sd=jttv.errorobs_flatten, observed=jttv.tcobs_flatten, param_space="unconstrained",
                                                model_args=(sample_keys_lnpmass, param_bounds))['fisher']
...
if __name__ == "__main__":
    test_information_from_model_iid()
